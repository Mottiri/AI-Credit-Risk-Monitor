...
Personal dashboard for monitoring AI bubble risk through credit, market stress, AI demand, rates, and liquidity indicators.
...
Add `FRED_API_KEY` as a GitHub Actions repository secret, then run the workflow manually once from the Actions tab. It is scheduled for weekdays at `22:15 UTC`, or `07:15 Japan time` the next morning.
